...
const Rangos: React.FC<Props> = ({ dataFrame, selectedKey }) => {
  ...
  const totalPopulation = dataFrame["total_population_CT"].values as number[];
  ...
  const mean =
    nonNullValues.reduce((a: number, b: number) => a + b, 0) /
        ...
        <div style={{ flex: 1, minWidth: "250px" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <tbody>
              <tr>
                <td>
                  <strong>Valores no nulos:</strong>
                </td>
                <td>{nonNullValues.length}</td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                <td>
                  <strong>Prom. ponderado:</strong>
                </td>
                <td>{weightedAvg.toFixed(6)}</td>
              </tr>
              <tr>
                <td>
                  <strong>75% (Q3):</strong>
